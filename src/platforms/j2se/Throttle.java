...
public class Throttle {
  ...
  /** throttle, frameskip constants **/
    static final int FRAMES_UNTIL_THROTTLE_RECALC = 20; // was 40
  ...
  /** The FPS that needs to be throttled to */
    ...
    fps = 0;
        ...
        minimumSleep = 0;//osname.endsWith("NT") ? 11 : 5;
        sleep = minimumSleep;
        throttleStep = DEFAULT_THROTTLE_STEP;
  ...
  private static void recalcTiming() {
    ...
    long tt = (tempT - t) / FRAMES_UNTIL_THROTTLE_RECALC;
    if (tt == 0)
    	fps = targetFPS;
    else
    	fps = 1000 / tt;
